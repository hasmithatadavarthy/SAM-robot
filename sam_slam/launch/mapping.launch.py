...
def generate_launch_description():
    ...
    pkg_sam_slam = get_package_share_directory('sam_slam')

    gazebo_models_path, ignore_last_dir = os.path.split(pkg_sam_slam)
    ...
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        arguments=['-d', PathJoinSubstitution([pkg_sam_slam, 'rviz', LaunchConfiguration('rviz_config')])],
