...
def generate_launch_description():
    ...
    pkg_sam_description = FindPackageShare('sam_description')
    default_rviz_config_path = PathJoinSubstitution([pkg_sam_description, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the sam_description package
